...
bpf = BPF(src_file = "http_parse_options.c",debug = 0)
print ("bound socket")
#load eBPF program http_filter of type SOCKET_FILTER into the kernel eBPF vm
#more info about eBPF program types
#http://man7.org/linux/man-pages/man2/bpf.2.html
function_http_filter = bpf.load_func("tcp_options_filter", BPF.SOCKET_FILTER)
...
print ("attached bpf program to socket created")
